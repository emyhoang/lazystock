...
var AuthService = /** @class */ (function () {
    function AuthService(http, router, platformId) {
        this.http = http;
        this.router = router;
        this.platformId = platformId;
        this.baseURL = 'http://localhost:3000/api';
    }
    AuthService.prototype.request = function (method, path, data) {
        var _this = this;
        var request;
        if (method === 'post') {
        ...
        request = request.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
            if (data.token) {
    ...
    AuthService.prototype.defaultHeaders = function () {
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.register = function () {
        var _this = this;
        this.auth.register(this.registerForm.value).subscribe(function () {
...
module.exports = __webpack_require__(/*! /Users/Bito/Desktop/lazystock/lazystock-front-end/src/main.ts */"./src/main.ts");
